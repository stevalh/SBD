                ...
                <div class="col-lg-6">
                    <form class="regis login100-form validate-form" action="{{ route('adminLoginPost') }}" method="POST">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                            <input class="email input100  @error('email') is-invalid @enderror" type="text"
                                value="{{ old('email') }}" name="email" placeholder="Full Name" required>
                            @error('email')
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                            <input class="email input100  @error('password') is-invalid @enderror" type="password"
